...
const BannerInformation = ({
    ...
    return (
        <div className="absolute right-6 top-2/3 transform -translate-x-[10%] -translate-y-1/2 bg-banner-background px-10 py-12 w-[630px] h-[400px]">
            <p className="text-base">New Arrival</p>
            <h2 className="text-button-background text-[52px] font-semibold">
                {titleBanner}
            </h2>
            <p className="text-lg font-medium text-text-category">
                {description}
            </p>
